...
import { Mention, MentionsInput } from "react-mentions/dist/react-mentions.cjs.prod";
import styles from "../../css/styles.module.css";

// Import the quill-emoji module
import 'quill-emoji';
        ...
        <Modal.Body className="px-4">
          ...
          <div className="row">
            ...
            <div className="richtextarea px-5">
              <p className="text-gray">Use @ for mentioning users.</p>
              <ReactQuill
                value={comment}
                onChange={setComment}
                modules={{
                  toolbar: [
                    ['bold', 'italic', 'code-block', 'emoji'], // Include 'emoji' in the toolbar
                  ],
                }}
                formats={[
                  'bold',
